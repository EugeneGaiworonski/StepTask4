...
// элемент массива принимает значение этого числа + 1
// (т.е. 6 для нашего примера), третий элемент массива предыдущий элемент + 1
// (т.е. 6*2=12 для нашего примера).
...
int main()
{
 int length = 0;
 int number = 0;
 cout<<"\t3Array length?= ";cin>>length;

 int (*array)[3] = new int[length][3];
